...
precision and recall (or sensitivity) values for each feasible threshold. The 
...
the horizontal axis, the points are interplated non-linearly to create a curve. 
